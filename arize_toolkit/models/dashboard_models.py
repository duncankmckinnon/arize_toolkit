...
from arize_toolkit.models.base_models import (
    BaseNode,
    Dimension,
    DimensionValue,
    Model,
...
class DashboardBasis(BaseNode):
    creator: Optional[User] = Field(
        default=None, description="The user who created the dashboard"
    )
    createdAt: Optional[datetime] = Field(
        default=None, description="The datetime the dashboard was created"
    )
    status: Optional[DashboardStatus] = Field(
        default=None, description="The status of the dashboard"
    )
...
class WidgetBasis(GraphQLModel):
    ...
    dashboardId: Optional[str] = Field(
        default=None, description="The dashboard ID of the widget"
    )
    title: Optional[str] = Field(default=None, description="The title of the widget")
    gridPosition: Optional[List[int]] = Field(
        default=None, description="The grid position of the widget"
    )
    creationStatus: Optional[WidgetCreationStatus] = Field(
        default=None, description="The creation status of the widget"
    )
...
class WidgetModel(GraphQLModel):
    ...
    createdAt: Optional[datetime] = Field(
        default=None, description="When the model was created"
    )
    modelType: Optional[ModelType] = Field(
        default=None, description="The type of the model"
    )
...
class StatisticWidgetFilterItem(GraphQLModel):
    ...
    dimensionValues: Optional[List[DimensionValue]] = Field(
        default=None, description="The dimension values"
    )
    binaryValues: Optional[List[str]] = Field(
        default=None, description="Binary values for filter"
    )
    numericValues: Optional[List[str]] = Field(
        default=None, description="Numeric values for filter"
    )
    categoricalValues: Optional[List[str]] = Field(
        default=None, description="Categorical values for filter"
    )
...
class BarChartPlot(GraphQLModel):
    ...
    position: Optional[int] = Field(
        default=None, description="The position of the plot"
    )
    modelId: Optional[str] = Field(
        default=None, description="The model ID for the plot"
    )
    modelVersionIds: Optional[List[str]] = Field(
        default=None, description="The model version IDs"
    )
    model: Optional[WidgetModel] = Field(default=None, description="The widget model")
    modelEnvironmentName: Optional[ModelEnvironment] = Field(
        default=None, description="The model environment"
    )
    dimensionCategory: Optional[DimensionCategory] = Field(
        default=None, description="The dimension category"
    )
    aggregation: Optional[DataQualityMetric] = Field(
        default=None, description="The aggregation type"
    )
    dimension: Optional[Dimension] = Field(default=None, description="The dimension")
    predictionValueClass: Optional[PredictionValueClass] = Field(
        default=None, description="The prediction value class"
    )
    rankingAtK: Optional[int] = Field(
        default=None, description="The ranking at K value"
    )
...
class BarChartWidgetConfig(GraphQLModel):
    ...
    keys: Optional[List[str]] = Field(
        default=None, description="The keys for the chart"
    )
    indexBy: Optional[str] = Field(default=None, description="The index by field")
    axisBottom: Optional[BarChartWidgetAxisConfig] = Field(
        default=None, description="Bottom axis configuration"
    )
    axisLeft: Optional[BarChartWidgetAxisConfig] = Field(
        default=None, description="Left axis configuration"
    )
...
class LineChartPlot(GraphQLModel):
    ...
    splitByEnabled: Optional[bool] = Field(
        default=None, description="Whether split by is enabled"
    )
    splitByDimension: Optional[str] = Field(
        default=None, description="The split by dimension"
    )
    splitByDimensionCategory: Optional[DimensionCategory] = Field(
        default=None, description="The split by dimension category"
    )
    splitByOverallMetricEnabled: Optional[bool] = Field(
        default=None, description="Whether split by overall metric is enabled"
    )
    cohorts: Optional[List[str]] = Field(
        default=None, description="Cohorts for the plot"
    )
    colors: Optional[List[str]] = Field(default=None, description="Colors for the plot")
    dimension: Optional[Dimension] = Field(default=None, description="The dimension")
    predictionValueClass: Optional[PredictionValueClass] = Field(
...
class LineChartWidgetConfig(GraphQLModel):
    ...
    axisBottom: Optional[LineChartWidgetAxisConfig] = Field(
        default=None, description="Bottom axis configuration"
    )
    axisLeft: Optional[LineChartWidgetAxisConfig] = Field(
        default=None, description="Left axis configuration"
    )
    curve: Optional[str] = Field(default=None, description="Curve type")
    xScale: Optional[LineChartWidgetXScaleConfig] = Field(
        default=None, description="X-axis scale configuration"
    )
    yScale: Optional[LineChartWidgetYScaleConfig] = Field(
        default=None, description="Y-axis scale configuration"
    )
...
class ExperimentChartPlot(GraphQLModel):
    ...
    evaluationMetric: Optional[str] = Field(
        default=None, description="The evaluation metric"
    )
...
class StatisticWidget(WidgetBasis):
    ...
    modelId: Optional[str] = Field(
        default=None, description="The model ID on the widget"
    )
    modelVersionIds: Optional[List[str]] = Field(
        default=None, description="The model version IDs on the widget"
    )
    dimensionCategory: Optional[DimensionCategory] = Field(
        default=None, description="The dimension category of the widget"
    )
    performanceMetric: Optional[PerformanceMetric] = Field(
        default=None, description="The performance metric function of the widget"
    )
    aggregation: Optional[DataQualityMetric] = Field(
        default=None, description="The data quality metric type of the widget"
    )
    predictionValueClass: Optional[PredictionValueClass] = Field(
        default=None, description="The class of the classification model on the widget"
    )
    rankingAtK: Optional[int] = Field(
        default=None, description="The @K value for the performance metric"
    )
    modelEnvironmentName: Optional[ModelEnvironment] = Field(
        default=None, description="The model environment of the widget"
    )
    timeSeriesMetricType: Optional[TimeSeriesMetricCategory] = Field(
        default=None, description="The type of timeseries metric on the widget"
    )
    filters: Optional[List[StatisticWidgetFilterItem]] = Field(
        default=None, description="Filters applied to the widget"
    )
    dimension: Optional[Dimension] = Field(default=None, description="The dimension")
    model: Optional[WidgetModel] = Field(default=None, description="The widget model")
    customMetric: Optional[CustomMetric] = Field(
        default=None, description="Custom metric if used"
    )
...
class BarChartWidget(WidgetBasis):
    ...
    sortOrder: Optional[str] = Field(
        default=None, description="Sort order for the bars"
    )
    ...
    isNormalized: Optional[bool] = Field(
        default=None, description="Whether the chart is normalized"
    )
    ...
    customBins: Optional[List[float]] = Field(
        default=None, description="Custom bin values"
    )
    quantiles: Optional[List[float]] = Field(
        default=None, description="Quantile values"
    )
    performanceMetric: Optional[PerformanceMetric] = Field(
        default=None, description="Performance metric"
    )
    plots: Optional[List[BarChartPlot]] = Field(
        default=None, description="Plots in the bar chart"
    )
    config: Optional[BarChartWidgetConfig] = Field(
...
class LineChartWidget(WidgetBasis):
    ...
    yMin: Optional[float] = Field(
        default=None, description="The minimum domain on the y-axis"
    )
    yMax: Optional[float] = Field(
        default=None, description="The maximum domain on the y-axis"
    )
    yAxisLabel: Optional[str] = Field(
        default=None, description="The label for the y-axis"
    )
    timeSeriesMetricType: Optional[str] = Field(
        default=None, description="The type of timeseries metric on the widget"
    )
    config: Optional[LineChartWidgetConfig] = Field(
        default=None, description="Widget configuration"
    )
    plots: Optional[List[LineChartPlot]] = Field(
        default=None, description="Plots in the line chart"
    )
...
class ExperimentChartWidget(WidgetBasis):
    ...
    plots: Optional[List[ExperimentChartPlot]] = Field(
        default=None, description="Plots in the experiment chart"
    )
...
class TextWidget(WidgetBasis):
    ...
    content: Optional[str] = Field(
        default=None, description="The content of the text widget"
    )
...
class BarChartWidgetDataKeysAndValuesObject(GraphQLModel):
    ...
    vType: BarChartWidgetDataValueObjectType = Field(
        description="The type of the value for 'v' above: 'number' or 'string'"
    )
...
class BarChartWidgetData(GraphQLModel):
    ...
    keysAndValues: List[BarChartWidgetDataKeysAndValuesObject] = Field(
        description="A list of objects of the form {k: 'some_key', v: 'some_value'} that provide data for a single bar in a bar chart"
    )
...
class DashboardPerformanceSlice(GraphQLModel):
    ...
    metricValueKey: Optional[str] = Field(
        default=None, description="The x-axis value that this metric applies to"
    )
    ...
    widget: Optional[BarChartWidget] = Field(
        default=None, description="The dashboard widget that this slice pertains to"
    )
...
class Dashboard(DashboardBasis):
    ...
    space: Optional[Space] = Field(
        default=None, description="The space that the dashboard belongs to"
    )
    models: Optional[List[Model]] = Field(
        default=None, description="A list of unique models referenced in this dashboard"
    )
    statisticWidgets: Optional[List[StatisticWidget]] = Field(
        default=None, description="The statistic widgets on the dashboard"
    )
    barChartWidgets: Optional[List[BarChartWidget]] = Field(
        default=None, description="The bar chart widgets on the dashboard"
    )
    lineChartWidgets: Optional[List[LineChartWidget]] = Field(
        default=None, description="The line chart widgets on the dashboard"
    )
    experimentChartWidgets: Optional[List[ExperimentChartWidget]] = Field(
        default=None, description="The experiment chart widgets on the dashboard"
    )
    driftLineChartWidgets: Optional[List[LineChartWidget]] = Field(
        default=None, description="The drift line chart widgets on the dashboard"
    )
    monitorLineChartWidgets: Optional[List[LineChartWidget]] = Field(
        default=None, description="The monitor line chart widgets on the dashboard"
    )
    textWidgets: Optional[List[TextWidget]] = Field(
        default=None, description="The text widgets on the dashboard"
    )
...
class CreateDashboardMutationInput(GraphQLModel):
    ...
    clientMutationId: Optional[str] = Field(
        default=None, description="Client mutation ID for tracking"
    )
...
class LineChartPlotInput(GraphQLModel):
    ...
    modelVersionIds: List[Optional[str]] = Field(
        default=[], description="The model version IDs"
    )
    ...
    filters: List[StatisticWidgetFilterItem] = Field(
        description="Filters applied to the widget"
    )
    dimensionCategory: Optional[DimensionCategory] = Field(
        default=None, description="The dimension category of the plot"
    )
...
class CreateLineChartWidgetMutationInput(GraphQLModel):
    ...
    timeSeriesMetricType: str = Field(
        default="modelDataMetric", description="The type of time series metric"
    )
