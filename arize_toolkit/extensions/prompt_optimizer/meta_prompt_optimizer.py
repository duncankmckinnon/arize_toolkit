...
class MetaPromptOptimizer:
    ...
    def optimize(self, context_size_k: int = 128000) -> Union[PromptVersion, List[Dict[str, str]], str]:
        """
        ...
        Returns:
            Optimized prompt in the same format as input (PromptVersion, list of messages, or string)
        ...
        batch_dataframes = splitter.get_batch_dataframes(self.dataset, columns_to_count, context_size_k)
        ...
        for i, batch in enumerate(batch_dataframes):
            ...
            try:
                ...
                model = OpenAIModel(model=self.model_choice, temperature=0.7, max_tokens=2000)
